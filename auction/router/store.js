...
const validateProduct = [
    body("price").trim().isLength({ max: 9 }).withMessage("시작 금액이 너무 높습니다").isNumeric().withMessage("시작 금액에는 숫자만 입력하세요"),
    body("name").trim().isLength({ min: 3 }).withMessage("제목이 너무 짧습니다"),
    validate,
];
